...
export default function Home() {
  return (
    <div className="bg-purple-400 min-h-screen flex flex-col">
      ...
      <nav className="fixed w-full bg-purple-400 p-6 text-white flex items-center justify-between top-0 shadow-md z-10">
      ...
      <section id="about" className="p-8 w-full items-center mt-5 text-justify flex">
        <div className="">
